...
describe("RegistryServices", () => {
    ...
    beforeEach(async () => {
        ...
        triggerRegistry = module.get<TriggerRegistryService>(TriggerRegistryService);
    ...
    describe("TriggerRegistryService", () => {
        ...
        it("should filter by provider", () => {
            triggerRegistry.register(mockTrigger);
            triggerRegistry.register({ ...mockTrigger, id: "t2", serviceProvider: "other" });
    ...
    describe("ActionRegistryService", () => {
        ...
        it("should filter by provider", () => {
            actionRegistry.register(mockAction);
            actionRegistry.register({ ...mockAction, id: "a2", serviceProvider: "other" });
