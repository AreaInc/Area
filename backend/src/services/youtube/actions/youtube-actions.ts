...
export class CreatePlaylistAction implements IAction {
    ...
    async validateInput(config: Record<string, any>): Promise<boolean> { return !!config.title; }
    getMetadata(): ActionMetadata { return { id: this.id, name: this.name, description: this.description, serviceProvider: this.serviceProvider, inputSchema: this.inputSchema, requiresCredentials: this.requiresCredentials }; }
}
...
export class DeletePlaylistAction implements IAction {
    ...
    async validateInput(config: Record<string, any>): Promise<boolean> { return !!config.playlistName; }
    getMetadata(): ActionMetadata { return { id: this.id, name: this.name, description: this.description, serviceProvider: this.serviceProvider, inputSchema: this.inputSchema, requiresCredentials: this.requiresCredentials }; }
}
...
export class RateVideoAction implements IAction {
    ...
    public readonly description = "Likes, dislikes, or removes rating from a video";
    public readonly type = ActionType.CREATE_DOCUMENT;
    public readonly serviceProvider = ServiceProvider.YOUTUBE;
    public readonly requiresCredentials = true;
    ...
    async validateInput(config: Record<string, any>): Promise<boolean> { return !!config.videoId && ["like", "dislike", "none"].includes(config.rating); }
    getMetadata(): ActionMetadata { return { id: this.id, name: this.name, description: this.description, serviceProvider: this.serviceProvider, inputSchema: this.inputSchema, requiresCredentials: this.requiresCredentials }; }
}
...
export class SubscribeChannelAction implements IAction {
    ...
    async validateInput(config: Record<string, any>): Promise<boolean> { return !!config.channelName; }
    getMetadata(): ActionMetadata { return { id: this.id, name: this.name, description: this.description, serviceProvider: this.serviceProvider, inputSchema: this.inputSchema, requiresCredentials: this.requiresCredentials }; }
}
...
export class CommentVideoAction implements IAction {
    ...
    async validateInput(config: Record<string, any>): Promise<boolean> { return !!config.videoId && !!config.comment; }
    getMetadata(): ActionMetadata { return { id: this.id, name: this.name, description: this.description, serviceProvider: this.serviceProvider, inputSchema: this.inputSchema, requiresCredentials: this.requiresCredentials }; }
}
