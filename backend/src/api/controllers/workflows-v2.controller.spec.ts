...
describe("WorkflowsV2Controller", () => {
    ...
    describe("createWorkflow", () => {
        ...
        it("should throw if no user", async () => {
            const req = { user: null };
            await expect(controller.createWorkflow(req as any, {} as any)).rejects.toThrow(BadRequestException);
        });
    });
    ...
    describe("updateWorkflow", () => {
        it("should update workflow", async () => {
            ...
            const result = await controller.updateWorkflow(req as any, "1", {} as any);
            expect(result).toEqual({ id: 1 });
        });
    });
    ...
    describe("activateWorkflow", () => {
        it("should activate workflow", async () => {
            const req = { user: { id: "user1" } };
            workflowsServiceMock.activateWorkflow.mockResolvedValue({ success: true });
    ...
    describe("deactivateWorkflow", () => {
        it("should deactivate workflow", async () => {
            const req = { user: { id: "user1" } };
            workflowsServiceMock.deactivateWorkflow.mockResolvedValue({ success: true });
    ...
    describe("executeWorkflow", () => {
        it("should execute workflow", async () => {
            ...
            const result = await controller.executeWorkflow(req as any, "1", { triggerData: {} });
