...
describe("OAuth2CredentialController", () => {
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            ...
            providers: [
                { provide: OAuth2Service, useValue: oauth2ServiceMock },
            ],
        })
        ...
        controller = module.get<OAuth2CredentialController>(OAuth2CredentialController);
    });
    ...
    describe("initiateAuth", () => {
        it("should redirect", async () => {
            ...
            oauth2ServiceMock.getAuthUrl.mockResolvedValue({ authUrl: "http://test" });
    ...
    describe("handleCallback", () => {
        it("should handle success", async () => {
            const res = { redirect: jest.fn() };
            oauth2ServiceMock.handleCallback.mockResolvedValue({ success: true, credentialId: 1 });
        ...
        it("should handle error", async () => {
            ...
            await controller.handleCallback("code", "state", res as any);
            expect(res.redirect).toHaveBeenCalledWith(expect.stringContaining("success=false"));
        });
    });
