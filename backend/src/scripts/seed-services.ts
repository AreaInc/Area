...
async function seed() {
    ...
    const servicesData = [
        ...
        },
        {
            ...
            version: "1.0.0",
            supportedActions: ["create_document", "add_row", "update_cell", "read_range"],
            credentialTypes: ["oauth2"],
            isActive: true,
        },
        {
            ...
            version: "1.0.0",
            supportedActions: ["play_music", "add_to_playlist", "create_document", "skip_track", "pause_playback", "like_current_track"],
            credentialTypes: ["oauth2"],
            isActive: true,
        },
        {
            ...
            imageUrl: "https://upload.wikimedia.org/wikipedia/commons/d/dd/Twitch_Glitch_Logo_purple.svg",
            version: "1.0.0",
            supportedActions: ["update_stream_title", "send_chat_message", "create_clip", "start_commercial", "create_stream_marker"],
            credentialTypes: ["oauth2"],
            isActive: true,
        },
        {
            ...
            version: "1.0.0",
            supportedActions: ["create_document", "delete_document", "rate_video", "subscribe_channel", "unsubscribe_channel", "comment_video"],
            credentialTypes: ["oauth2"],
            isActive: true,
        },
    ];
