...
VALUES
  ...
  ('twitch', 'Twitch', 'Interact with live streams and chat.', 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/24_hour_Clock_symbols_icon_11.png/640px-24_hour_Clock_symbols_icon_11.png', '1.0.0', '["update_stream_title", "send_chat_message", "create_clip", "start_commercial", "create_stream_marker"]'::jsonb, '["oauth2"]'::jsonb, true),
  ...
  ('scheduler', 'Scheduler', 'Schedule workflows with cron expressions or trigger on activation.', 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/24_hour_Clock_symbols_icon_11.png/640px-24_hour_Clock_symbols_icon_11.png', '1.0.0', '[]'::jsonb, '[]'::jsonb, true),
  ('telegram', 'Telegram', 'Send messages, photos, and manage Telegram bots.', 'https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg', '1.0.0', '["send_message", "send_photo", "pin_message", "kick_member", "unban_member"]'::jsonb, '["api_key"]'::jsonb, true),
  ('google-calendar', 'Google Calendar', 'Create and manage calendar events.', 'https://upload.wikimedia.org/wikipedia/commons/a/a5/Google_Calendar_icon_%282020%29.svg', '1.0.0', '["create_event", "quick_add"]'::jsonb, '["oauth2"]'::jsonb, true),
  ('discord', 'Discord', 'Send messages to Discord channels via webhooks.', 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/24_hour_Clock_symbols_icon_11.png/640px-24_hour_Clock_symbols_icon_11.png', '1.0.0', '["send_webhook"]'::jsonb, '["custom"]'::jsonb, true)
